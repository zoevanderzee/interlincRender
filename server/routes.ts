...
The code includes modifications to the profile code generation and connection request endpoints to support bidirectional connections between businesses and contractors, and to ensure profile codes can be generated for both user types.
